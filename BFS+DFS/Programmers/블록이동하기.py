...
def bfs(board, N):
    ...
    while (queue):
        ...
        for d in dir:
            ...
            if nl[0] < 0 or nl[1] < 0 or nr[0] < 0 or nr[1] < 0 or nl[
                    0] >= N or nl[1] >= N or nr[0] >= N or nr[1] >= N:
                continue
        ...
        for t in turn_list:
            ...
            for d in turn_dir:
                ...
                if tl[0] < 0 or tl[1] < 0 or tr[0] < 0 or tr[1] < 0 or tl[
                        0] >= N or tl[1] >= N or tr[0] >= N or tr[1] >= N:
                    continue
